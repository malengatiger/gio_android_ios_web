...
class AuthRegistrationMain extends StatelessWidget {
  const AuthRegistrationMain({Key? key, required this.prefsOGx, required this.dataApiDog, required this.cacheManager}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ScreenTypeLayout(
      mobile:  AuthPhoneRegistrationMobile(prefsOGx: prefsOGx, dataApiDog: dataApiDog, cacheManager: cacheManager,),
